...
-Pathfinding.java is the main class
-Read.java is a class to read in the data from the text file
-Write.java if a class to write out the data after it has been processed. 
